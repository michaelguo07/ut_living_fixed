              ...
              <div className="flex items-center gap-3">
                {member.instagram && (
                  ...
                  >
                    ...
                    <span className="hidden md:inline">@{member.instagram}</span>
                  </a>
                )}
                {member.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-xs font-medium text-stone-500 hover:text-[#0077B5] transition-colors"
                  >
                    <svg
                      className="h-4 w-4 fill-current text-stone-400 hover:text-[#0077B5] transition-colors"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    >
